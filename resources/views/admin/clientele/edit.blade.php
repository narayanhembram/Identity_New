                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="title" class="form-control">
                                        ...
                                        <option value="Goverment Clients" {{ ($edit->title == "Goverment Clients")? 'selected' : '' }}>Goverment Clients</option>
                                        <option value="Schools and Colleges" {{ ($edit->title == "Schools and Colleges")? 'selected' : '' }}>Schools and Colleges</option>
