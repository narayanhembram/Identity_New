        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="title mt-3 mt-lg-0">
                    ...
                    <p style="text-align: justify;">{{ __(@$about->data_values->short_description) }}</p>
                </div>
                <div class="info">
                ...
                <div>
                    <button class="btn--base" onclick="document.location='https://identity.zpsdemo.in/about'">Discover More</button>
                </div>
            </div>
        </div>
    </div>
